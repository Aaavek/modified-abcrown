...
class ConfigHandler:
    ...
    def add_common_options(self):
        ...
        self.add_argument('--k', type=int, default=5, help='Value of k times k.', hierarchy=["k"])
        self.add_argument('--imagepath', type=str, default="image.jpg", help="Image path of the test case.", hierarchy=["imagepath"])
        self.add_argument('--modelpath', type=str, help="Model path of the test case.", hierarchy=["modelpath"])
        ...
        self.add_argument('--data_min', type=float, help='Minimum value of the input data.',default=-float('inf'), hierarchy=h + ["data_min"])
        self.add_argument('--data_max', type=float, help='Maximum value of the input data.',default=float('inf'), hierarchy=h + ["data_max"])
